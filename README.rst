...
`Web GUI <https://siameselab.github.io/quesadiya/build/html/collaborator.html#collaborator>`__ to generate a triplet data set for developing Siamese models. Let's say you have a section as anchor and an article (i.e. a group of sections) as candidate. With quesadiya, you can visually select a section in the candidate, which is the most similar to the anchor.
